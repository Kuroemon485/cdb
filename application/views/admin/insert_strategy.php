...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add new strategy</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
     <div class="box box-solid box-primary">
        <div class="box-header">
            <h3 class="box-title">Add new strategy</h3>
        </div>
        <div class="box-body">
            <div class="row">
            ...
            <div class="col-md-4 col-xs-4">
                ...
                <button id="submit-strategy" class="btn btn-primary btn-sm" data-work-mode="add"><i class="fa fa-check"></i> Submit</button>
            </div>
